...
namespace EduSense.DAL.Migrations
{
    ...
    [Migration("20260921120000_AddScaleTypeToAnswerOption")]
    partial class AddScaleTypeToAnswerOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduSense.DAL.Models.CategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduSense.DAL.Models.QuestionModel", b =>
                {
                    b.HasOne("EduSense.DAL.Models.CategoryModel", "Category")
                        .WithMany("Questions")
